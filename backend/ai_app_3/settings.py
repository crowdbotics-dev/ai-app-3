"""
Django settings for ai_app_3 project.
...
WSGI_APPLICATION = 'ai_app_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ai_app_3 API",
    "DESCRIPTION": "API documentation for ai_app_3 App",
    "VERSION": "v1",
}
